...
<div class="wrap">
    <div class="body-wrap">
        ...
        <header class="site-header">
			...
			<div style="text-align: center; background: #ffcc00; padding: 10px; font-size: 16px; font-weight: bold;">
			    NEW Chapters uploaded from Sep 9 2025 can be translated into any language using google translate,
                You want an ad-free experience? Subscribe to our 
                <a href="https://ko-fi.com/manhuarm" target="_blank" style="color: #0000EE; text-decoration: underline;">
                    no-ads membership here
        		</a>
